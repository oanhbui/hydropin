...
const RatingForm = ({ stationID, afterSubmit }) => {
    ...
    return (
        <div>
            ...
            {createPortal(
                <div className={`modal fade ${modalRatingForm ? 'show' : ''}`} id="ratingForm" tabindex="-1" style={{ display: modalRatingForm ? 'block' : 'none', backgroundColor: 'rgba(0,0,0,0.25)' }} onClick={handleModalRatingForm}>
